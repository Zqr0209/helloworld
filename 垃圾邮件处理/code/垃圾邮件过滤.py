...
def email_parser(email_path):
    clean_word = textParse(open(email_path, encoding='ISO-8859-1').read())
    return clean_word
...
def main():
    ham_file = r'C:\Users\lenovo\Desktop\第四课训练样本\email\ham'
    spam_file = r'C:\Users\lenovo\Desktop\第四课训练样本\email\spam'
